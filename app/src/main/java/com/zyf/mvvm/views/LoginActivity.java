...
import com.zyf.mvvm.viewModels.LoginViewModel;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                // Retrieve data rows for the device mainViewModel's 'profile' contact.
                ...
                // a primary email address if the mainViewModel hasn't specified one.
